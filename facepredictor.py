...
def predictperson():
	...
	while(True):
    	...
    	cv2.rectangle(frame,start,end,(255,0,0),3)
		#cv2.rectangle(frame, (400, 100), (900, 550), (255,0,0), 2)
		#cv2.putText(frame,"Please keep your head inside the blue box and have only one face in the frame", (10, 700), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)

		faces_inside_box = 0
		for (x, y, w, h) in faces:
			if x<800 and x>160 and y<300 and y>120 and (x+w)<480 and (x+w)>160 and (y+h)<360 and (y+h)>120:
				faces_inside_box+=1
